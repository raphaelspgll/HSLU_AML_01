...
heapo_daily %>%
  ...
  labs(
    title = "Median Daily Consumption Across All Households",
    x = "Date",
    y = "kWh (Median)"
  ) +
  theme_minimal()
...
ggplot(
  heapo_daily,
  aes(x = heatpump_type, y = kWh_total, fill = heatpump_type)
) +
  geom_boxplot(outlier.alpha = 0.2) +
  labs(title = "Daily Consumption by Heat Pump Type", x = "", y = "kWh") +
  theme_minimal() +
